...
def cargarDatos(fase, numeroCategorias, limite):
    ...
    for categoria in range(1, numeroCategorias):
        for idImagen in range(0, limite):
            # dataset/categoria/categoria_grupo_consecutivo.jpg
            ruta = fase + str(categoria) + "/" + str(categoria) + "_" + str(categoria) + "_" + str(idImagen) + ".jpg"
            print(ruta)
...
nombreArchivo = 'models/modeloReconocimientoAves.keras'
